...
const Navbar = () => {
    return (
        <nav className='bg-cyan-100'>
            ...
            <ul>
                <li><a className='flex gap-1 border border-cyan-700 p-2 hover:bg-cyan-500 hover:rounded-full hover:transition-all hover:duration-500' href=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
