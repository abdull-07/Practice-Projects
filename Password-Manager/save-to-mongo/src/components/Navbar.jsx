    ...
    return (
        <nav className='bg-cyan-100'>
            <div className="mycontainer flex text-black justify-between items-center font-bold italic py-2 max-w-4xl">
                ...
                <div><a className='flex gap-1 p-2 hover:bg-cyan-500 hover:rounded-full hover:transition-all hover:duration-1000' href="https://github.com/abdull-07/Practice-Projects/tree/main/Password-Manager/save-to-localStorage" target='_blank'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
